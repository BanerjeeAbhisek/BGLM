...
//[[Rcpp::depends(RcppArmadillo)]]
//[[Rcpp::export]]
Rcpp::List BVSG(Rcpp::NumericMatrix X,Rcpp::NumericVector Y, double a_init,double b_init,double r_init,Rcpp::NumericVector beta_init,Rcpp::NumericMatrix Lambda_init,double sigma2_init,double ahyper,double bhyper,double rhyper,int Nburn,int Niter,int Nthin){
...
Rcpp::NumericVector XtYminusYbar(p);
XtYminusYbar = Rcpp::as<Rcpp::NumericVector>(Rcpp::wrap(xtyminusybar));
...
arma::mat Lambdahat(p,p);
    ...
    for(int i=0;i<Nburn;i++){
        ...
        sigma2     = samplesigma2inC(Lambda,XtX,XtYminusYbar,Y);
        beta       = sampleBetainC(sigma2,Lambda,XtX,XtYminusYbar);
