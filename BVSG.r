...
BVSGR <-function(X, Y, a_init, b_init, r_init, Beta_init, Lambda_init, sigma2_init,ahyper,bhyper,rhyper, Nburn, Niter,Nchain,Nthin){
...
for (i in 1: Nchain) {
BVSGR[[i]] = BVSG(X, Y, a_init, b_init, r_init, Beta_init, Lambda_init, sigma2_init,ahyper,bhyper,rhyper, Nburn, Niter,Nthin);
